CLASS zcl_hungxa_api_country_srv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_hungxa_api_country_srv IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    TRY.
        ...
        DATA(lo_http_destination) =
             cl_http_destination_provider=>create_by_url( 'https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_COUNTRY_SRV/A_Country?$top=50' ).
        ...
        (  name = 'APIKey' value = 'ExyymXzc47YqUDzxOBm5AAZ8KvjRTmYx' )
